...
public class Login {
	...
	//imagenes
	ImageIcon img1 = new ImageIcon("C:\\Users\\LuisA\\Desktop\\Cine\\Cine\\src\\login.png");
	JLabel backg;
	...
	public void crear_login () {
		...
		backg.setBounds(215, 50, 100, 100);
		pn_login.add(backg);
		...
		lb_user.setLocation(167, 165);
		txt_user.setLocation(167, 210);
		lb_pass.setLocation(167, 240);
		txt_pass.setLocation(167, 285);
